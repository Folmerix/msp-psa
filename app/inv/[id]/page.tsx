...
export default function PublicInvoicePage() {
  ...
  if (notFound) return <div className="min-h-screen flex items-center justify-center text-gray-400 text-sm">Invoice not found.</div>;
  ...
  return (
    <>
      ...
      <div className="min-h-screen bg-gray-200 py-8 px-4">
        {justPaid && (
          <div className="no-print max-w-[850px] mx-auto mb-3 bg-green-50 border border-green-200 rounded-xl px-5 py-3 text-green-700 text-sm font-medium text-center">
        ...
        <div className="doc max-w-[850px] mx-auto bg-white shadow-xl rounded-lg overflow-hidden" style={{ fontFamily: "Arial, sans-serif" }}>
          ...
          <div className="flex items-start justify-between px-8 pt-8 pb-4">
            ...
            <div className="text-right">
              ...
              <p style={{ fontSize: 11, color: "#888", fontStyle: "italic", marginTop: 4 }}>
                {isPaid ? `Paid on ${new Date(invoice.paid_at!).toLocaleDateString()}` : "Payment due as specified below"}
              </p>
            </div>
          </div>
              ...
              <table style={{ width: "100%", borderCollapse: "collapse", border: `1px solid #c8d5e4`, fontSize: 12 }}>
                <tbody>
                  ...
                  <tr>
                    ...
                    <td className="cell-value">{new Date(invoice.created_at).toLocaleDateString()}</td>
                  </tr>
                  {invoice.due_date && (
                    <tr>
                      <td className="cell-label">Due Date</td>
                      <td className="cell-value" style={{ fontWeight: 600, color: isPaid ? "#16a34a" : "#dc2626" }}>
              ...
              <table style={{ width: "100%", borderCollapse: "collapse", fontSize: 12 }}>
                <tbody>
                  <tr style={{ borderBottom: "1px solid #e5eaf0" }}>
                    ...
                    <td className="cell-value" style={{ textAlign: "right" }}>${invoice.subtotal.toFixed(2)}</td>
                  </tr>
                  <tr style={{ borderBottom: "1px solid #e5eaf0" }}>
                    <td className="cell-label">Tax Rate</td>
                    <td className="cell-value" style={{ textAlign: "right" }}>{invoice.tax_rate}%</td>
                  </tr>
                  <tr style={{ borderBottom: "1px solid #e5eaf0" }}>
          ...
          {/* ── PAY NOW ── */}
          {!isPaid && (
            <div style={{ borderTop: "1px solid #e5eaf0", padding: "24px 32px", textAlign: "center" }}>
              <a
              ...
              <p style={{ fontSize: 11, color: "#999", marginTop: 8 }}>Secure payment</p>
            </div>
          )}
