      ...
      <form onSubmit={handleSubmit} className="space-y-5">
        <div className="bg-white rounded-xl border p-6 space-y-4">
          ...
          <div className="grid grid-cols-2 gap-4">
            ...
            <div>
              <label htmlFor="taxRate" className="block text-sm font-medium mb-1">Tax Rate (%)</label>
              <input id="taxRate" type="number" min="0" max="100" step="0.01" value={taxRate}
            ...
            {items.map((item, i) => (
              <div key={i} className="grid grid-cols-[1fr_1fr_64px_96px_32px] gap-2 items-start">
                ...
                <button
                  ...
                  className="text-gray-300 hover:text-red-400 text-lg leading-none disabled:opacity-0 pt-2"
                >
                  ✕
                </button>
              </div>
