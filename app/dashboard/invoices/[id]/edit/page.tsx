          ...
          <div style={{ overflow: "hidden", boxShadow: "0 1px 8px rgba(0,0,0,0.10)" }}>
            <div style={{ width: 850, zoom: 0.47, background: "white", fontFamily: "Arial, sans-serif", fontSize: 12, color: "#333" }}>
              ...
              <div style={{ display: "flex", alignItems: "flex-start", justifyContent: "space-between", padding: "24px 32px 16px" }}>
                ...
                <div style={{ textAlign: "right" }}><p style={{ fontSize: 26, fontWeight: 900, color: docP, letterSpacing: 3, margin: 0 }}>INVOICE</p><p style={{ fontSize: 10, color: "#aaa", fontStyle: "italic", margin: "2px 0 0" }}>Live preview</p></div>
              </div>
              ...
              <div style={{ display: "flex", gap: 24, padding: "0 32px 16px" }}>
                ...
                <div style={{ width: 220 }}>
                  <table style={{ width: "100%", borderCollapse: "collapse", border: `1px solid #c8d5e4`, fontSize: 11 }}><tbody>
                    <tr><td style={{ backgroundColor: docP, color: "white", fontWeight: 700, padding: "3px 8px", width: 80 }}>Invoice #</td><td style={{ padding: "3px 8px", borderBottom: "1px solid #e5eaf0", color: "#aaa", fontStyle: "italic" }}>Editing…</td></tr>
